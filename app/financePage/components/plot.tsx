    ...
    <div className="w-full h-[700px]">
      <Plot
        ...
        layout={{
          ...
          yaxis: { title: { text: "Price (USD)" }, domain: [0.4, 1], rangemode: "tozero" },
          yaxis2: { title: { text: "Volume" }, domain: [0.25, 0.35], rangemode: "tozero" },
          yaxis3: { title: { text: "Indicators" }, domain: [0, 0.2], rangemode: "tozero" },
          paper_bgcolor: "black",
          plot_bgcolor: "black",
          font: { color: "white" },

...
export default function InfoChart({ symbol, live = false }: Props) {
  ...
  return (
    <div className="flex-1 rounded-2xl border border-border bg-card p-8 shadow-lg text-foreground min-h-[400px]">
      ...
      {loading ? (
        ...
        <ul className="space-y-3 text-base">
          ...
          <li>
            <span className="font-semibold">Forward P/E:</span>{" "}
        ...
        <p className="text-muted-foreground">No fundamentals available.</p>
      )}
    </div>
  );
}

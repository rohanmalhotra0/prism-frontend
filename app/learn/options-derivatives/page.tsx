    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative z-10 min-h-screen">
          ...
          <div className="bg-card rounded-2xl p-8 border border-border">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                ...
                <h4 className="text-foreground font-semibold mb-2">Basics</h4>
                <p className="text-muted-foreground text-sm">Options terminology, payoffs</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">2</div>
                <h4 className="text-foreground font-semibold mb-2">Pricing Models</h4>
                <p className="text-muted-foreground text-sm">Black-Scholes, Binomial</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">3</div>
                <h4 className="text-foreground font-semibold mb-2">Greeks & Risk</h4>
                <p className="text-muted-foreground text-sm">Sensitivity analysis, hedging</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">4</div>
                <h4 className="text-foreground font-semibold mb-2">Advanced</h4>
                <p className="text-muted-foreground text-sm">Exotic options, strategies</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-card rounded-2xl p-8 border border-border">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                ...
                <p className="text-muted-foreground text-xs">Programming language</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">•</div>
                <h4 className="text-foreground font-semibold mb-1">QuantLib</h4>
                <p className="text-muted-foreground text-xs">Quantitative finance library</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">🔢</div>
              ...
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">•</div>
                <h4 className="text-foreground font-semibold mb-1">Bloomberg</h4>
                <p className="text-muted-foreground text-xs">Market data & analytics</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">💼</div>
                <h4 className="text-foreground font-semibold mb-1">Refinitiv</h4>
                <p className="text-muted-foreground text-xs">Financial data platform</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">•</div>
                <h4 className="text-foreground font-semibold mb-1">Derivatives Pro</h4>
                <p className="text-muted-foreground text-xs">Options pricing software</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">•</div>
                <h4 className="text-foreground font-semibold mb-1">Excel</h4>
                <p className="text-muted-foreground text-xs">Spreadsheet modeling</p>
              </div>
              <div className="bg-muted rounded-xl p-4 border border-border text-center">
                <div className="text-2xl mb-2">⚡</div>
                <h4 className="text-foreground font-semibold mb-1">C++</h4>
                <p className="text-muted-foreground text-xs">High-performance computing</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pb-20 text-center">
          <h3 className="text-2xl font-bold text-foreground mb-4">Ready to Master Options & Derivatives?</h3>
